...
class DonacionOrganizacionRepositoryImpl implements DonacionOrganizacionRepository {
  ...
  @override
  Future<List<DonacionRecibidaEntity>> obtenerMisDonaciones() async {
    final models = await remoteDataSource.obtenerMisDonaciones();
    return models; // DonacionRecibidaModel ya extiende de DonacionRecibidaEntity
  }
}