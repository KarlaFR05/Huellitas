...
class AdopcionRespuestasScreen
  ...
  Widget build(BuildContext context) {
    ...
    final porcentaje =
        postulacion.porcentajeAptitud.clamp(
      0,
      100,
    );
            ...
            child: ListView(
              ...
              children: [
                ...
                Text(
                  ...
                  '${postulacion.nombre} proporcionó '
                  'para adoptar a ${adopcion.nombre}.',
                  style: TextStyle(
                    color:
